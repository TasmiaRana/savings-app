...
export default function Button({
  ...
  const baseLayout = "w-full py-3 px-4 rounded-xl text-sm font-semibold gap-1.5 flex items-center justify-center";

  const variants = {
    primary: "cursor-pointer bg-emerald-600 hover:bg-emerald-500 text-white shadow-md shadow-emerald-950/40 transition tracking-wide", 
